...
function Home(props) {
    ...
    let isHome;
    window.location.href === "http://localhost:3000/" || window.location.href === "http://localhost:3000/home" || window.location.href === "http://localhost:3000/Home" ?
        isHome = 1 :
        isHome = 0;
